...
class ConfirmOrderForm(forms.Form):
    ...
    email = forms.CharField(label='Billing contact email', max_length=50)
    ...
    street_line_two = forms.CharField(label='Street Line 2', max_length=100, help_text="Second line of street address")
    street_line_three = forms.CharField(label='Street Line 3', max_length=100, help_text="Third line of street address")
    city = forms.CharField(label='City', max_length=50, help_text="Town or city")
    region = forms.CharField(label='Region', max_length=50, help_text="Region")

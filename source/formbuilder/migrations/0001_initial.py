# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-16 10:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('side_panel_title', models.CharField(blank=True, max_length=255)),
                ('side_panel_content', wagtail.wagtailcore.fields.RichTextField(blank=True)),
        ...
        migrations.AddField(
            ...
            name='page',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='formbuilder.FormPage'),
        ),
    ]
